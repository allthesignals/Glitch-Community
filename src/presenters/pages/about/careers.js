    ...
    <AboutLayout mainClassName={styles.main} currentPage="careers">
      ...
      <BlockSection>
        ...
        <article>
          ...
          <p>
            Each person takes turns keeping notes because we don’t want women or other underrepresented team members to feel unduly obligated to
            handle such tasks, and every meeting with more than 2 people has notes shared to the entire company so that everyone knows what’s going
            on.
          </p>
        </article>
        <article>
          ...
          <p>
            There are exceptions for roles where people are on-call or special cases like events or unusual circumstances, but on a day-to-day basis,
            we are enormously productive by letting people live their lives and have their downtime.
          </p>
        </article>
        <article>
          <Heading tagName="h3">Almost no email</Heading>
          <p>
            Most people at Glitch get fewer than a dozen email messages in a week from their coworkers. We use email for especially urgent
            company-wide alerts, and to work with people at other companies.
          </p>
          <p>
        ...
        <article>
          ...
          <p>
            People are regularly asked to jump through bizarre hoops in job interviews, like undertaking whiteboard coding challenges. We think
            they’re exclusionary and pointless.
          </p>
