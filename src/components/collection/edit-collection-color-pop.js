...
const EditCollectionColor = ({ update, initialColor }) => (
  <Popover className={styles.container} align="left" containerClass="edit-collection-color-btn" renderLabel={({ onClick, ref }) => <Button onClick={onClick} ref={ref}>Color</Button>}>
